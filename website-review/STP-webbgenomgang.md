...
2. **Kärnlöftet – matchning – är buggigt.** Samma jobb + samma förare visar **fyra olika matchningssiffror** beroende på vy (0 % / 5 % / 29 % / 45 %), och råa databasfältnamn ("Digitalt_fardskrivarkort") läcker till UI:t.
...
**Övriga buggar:**
- **Råa databasfältnamn läcker till UI.** På jobbdetaljsidan: "Certifikat: YKB, **Digitalt_fardskrivarkort, Forarkort**" – understreck och saknade å/ö. Visar interna enum-nycklar i stället för etiketter.
