...
import { CheckIcon, BuildingIcon, ShieldCheckIcon, ArrowRightIcon } from "../components/Icons";
...
const COMPANY_SEGMENTS = [
  ...
  {
    title: "Praktik/skola",
    text: "För företag som vill synas mot elever och framtida förare och bygga relationer tidigt.",
  },
];
