...
const Problem = () => (
  <Section bg="var(--paper)">
    ...
    <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 18 }} className="p3">
      ...
      {[{ no: "01", title: "Ingen struktur", body: "Körkort, erfarenhet och tillgänglighet begrävs i fritext och kommentarsfält. Ingen vet vem som är seriös." }, { no: "02", title: "Mellanhänder äter lönen", body: "Bemanningsbolag tar en stor del av lönen. Föraren förlorar. Åkeriet betalar mer. Ingen vinner." }, { no: "03", title: "Bra kandidater försvinner", body: "En jobbannons lever 24 timmar på sociala medier. Rätt förare ser den aldrig. Åkeriet upprepar processen." }].map((p) => (
