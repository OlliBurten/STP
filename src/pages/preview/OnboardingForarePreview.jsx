          ...
          {step === 0 && (
            <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                {[{ icon: "search", title: "Automatisk matchning", text: "Vi matchar dig mot jobb baserat på körkort, region och vad du söker." }, { icon: "eye", title: "Synlig för åkerier", text: "Du väljer om profilen är synlig — då kan åkerier hitta dig när de rekryterar." }, { icon: "msg", title: "Ansök direkt", text: "Du ansöker direkt hos arbetsgivaren eller via STP — utan mellanhand." }].map((b) => (
