  ...
  return (
    <div style={{ width: "100%", background: "var(--paper-2)", borderBottom: "1px solid var(--line)" }}>
      <div style={{
        ...
        {/* Vänster-spacer = ×-knappens bredd → mittgruppen blir exakt centrerad */}
        <span aria-hidden="true" style={{ width: 20, flexShrink: 0 }} />

        {/* Centrerad grupp: progress + text + CTA */}
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", flexWrap: "wrap", gap: 16, minWidth: 0 }}>
        ...
        <button onClick={dismiss} aria-label="Stäng" style={{
          ...
          fontSize: "var(--text-xl)", lineHeight: 1, padding: 0,
        }}>
          ×
        </button>
      </div>
