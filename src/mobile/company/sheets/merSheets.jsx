...
export function VerificationSheet({ ctx, close }) {
  ...
  return (
    <div style={{ padding: "4px 22px 26px" }}>
      ...
      <p style={{ fontSize: 14.5, color: "var(--ink-600)", lineHeight: 1.55, marginBottom: 16 }}>{verified ? "Er profil visar en Verifierad-stämpel som förare litar på." : "Verifieringen sker automatiskt på ert organisationsnummer."}</p>
