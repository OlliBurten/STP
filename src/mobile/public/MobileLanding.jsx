...
const FAQS = [
  ...
  ["Kostar det något?", "För förare är STP gratis just nu. Åkerier kommer igång gratis och betalar först för utökade funktioner när de vill nå fler förare."],
