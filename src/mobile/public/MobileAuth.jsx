    ...
    body = (
      <div className="view-enter app-scroll" style={{ flex: 1, display: "flex", flexDirection: "column", overflowY: "auto" }}>
        <div style={{ padding: "24px 26px 30px" }}>
          ...
          <Strength pw={pw} />
          <button role="checkbox" aria-checked={agree} aria-label="Jag godkänner användarvillkor och integritetspolicy" onClick={() => { setAgree((a) => !a); setErr((e) => ({ ...e, agree: undefined })); }} style={{ display: "flex", alignItems: "flex-start", gap: 11, textAlign: "left", marginBottom: err.agree ? 6 : 20 }}>
