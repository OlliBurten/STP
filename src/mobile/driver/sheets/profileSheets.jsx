      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 12, marginBottom: 24 }}>
        ...
        {exp.map((e, i) => (
          <div key={e.id || i} style={{ padding: "14px", background: "var(--card-2)", border: "1px solid var(--line)", borderRadius: 13, position: "relative" }}>
            <button onClick={() => rmExp(i)} className="press" style={{ position: "absolute", top: 10, right: 10, width: 26, height: 26, borderRadius: 13, background: "#fff", border: "1px solid var(--line)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 2 }}><Icon name="x" size={13} color="var(--ink-400)" stroke={2.4} /></button>
